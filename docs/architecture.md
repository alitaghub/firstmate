...
A home that has opted into the captain's Telegram channel also gets the injected digest as a phone push, strictly after the injection has landed and with every failure swallowed, so the pane escalation is never blocked or delayed by it; [`telegram.md`](telegram.md#what-outbound-may-carry) owns which digests are pushed.
