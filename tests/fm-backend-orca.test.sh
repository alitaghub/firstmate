...
test_spawn_writes_orca_metadata_and_launches_harness() {
  ...
  assert_contains "$(cat "$log")" "CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION=false CLAUDE_CODE_SEND_FEEDBACK=0 claude --dangerously-skip-permissions --setting-sources project,local --settings '$state/$id.claude-settings.json'" \
